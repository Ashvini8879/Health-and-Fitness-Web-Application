    ...
    if (roundTimeInput.value === "" || restTimeInput.value === "") {
     ...
     // setAlert(alert10sec);
      ...
      setTimeout(() => {
        ...
        setInterval(() => {
          if (round1.innerText !== "0:00") {
            ...
            round1.innerText === "0:00" ? setAlert1(alertStop) : round1;
            ...
            rest1.innerText === "0:00" ? setAlert1(alertStart) : rest1;
            ...
            round2.innerText === "0:00" ? setAlert1(alertStop) : round2;
            ...
            rest2.innerText === "0:00" ? setAlert1(alertStart) : rest2;
            ...
            round3.innerText === "0:00" ? setAlert1(alertStop) : round3;
          }
      ...
      function getReady(element) {
        let seconds = time % 60;
        element.innerHTML = `
        <h1 class='title'>Get Ready in</h1>
       <div class="inputs-container"> 
