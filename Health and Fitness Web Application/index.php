...
<body>
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="mem_login.php">Membership</a>
...
<div class="plan basic">
    <h3>weekly plan</h3>
    <div class="price"><span>₹</span>200<span>/week</span></div>
    <div class="list">
...
<div class="plan">
    <h3>monthly plan</h3>
    <div class="price"><span>₹</span>800<span>/month</span></div>
    <div class="list">
  ...
  <!--  ------[BANNER SECTION]-------------------------------------------------------------------------------------------------------->
    ...
    <section class="banner">
        ...
        <h3>get up to 3 free training sessions</h3>
        <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p> -->
        <a href="login.php" class="btn">lets go</a>
    </section>
