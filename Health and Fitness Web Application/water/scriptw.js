...
function showNotification() {
  ...
  intervalId = setInterval(hideNotification, 120000); // 2 minutes (120 seconds)
}
...
closeBtn.addEventListener("click", function() {
  hideNotification();
  setTimeout(showNotification, 8000); // 8 seconds
});

// Initial notification show after 8 seconds
